(function($) {
    ...
    var proCata = $('.pando-pro-catagory');
    ...
    var pandoSearch = $('.search-nav');
    var searchClose = $('.search-close');

    pandoSearch.on('click', function() {
    ...
    var pandoMobNav = $('.pando-navbar-toggler');
    var navClose = $('.nav-close');

    pandoMobNav.on('click', function() {
